...
const cmHighlight = HighlightStyle.define([
	...
	// keywords
	{ tag: TT(t.keyword, t.controlKeyword, t.operatorKeyword, t.definitionKeyword, t.moduleKeyword), color: 'var(--base08)', fontWeight: '700' },
	{ tag: TT(t.special(t.keyword)), color: 'var(--base0E)' },

	// operators & punctuation
	{ tag: TT(t.operator, t.compareOperator, t.arithmeticOperator, t.logicOperator, t.bitwiseOperator, t.updateOperator, t.definitionOperator, t.typeOperator, t.controlOperator, t.derefOperator), color: 'var(--base05)' },
	...
	// functions
	{ tag: TT(t.function(t.variableName), t.function(t.propertyName), t.function(t.definition(t.variableName)), t.function(t.name)), color: 'var(--base0D)', fontWeight: '600' },
	...
	// markdown-ish
	{ tag: TT(t.heading, t.heading1, t.heading2, t.heading3, t.heading4, t.heading5, t.heading6), color: 'var(--primary)', fontWeight: '800' },
	...
	{ tag: TT(t.code, t.monospace), color: 'var(--text)', backgroundColor: 'color-mix(in oklab, var(--text) 12%, transparent)' },
	...
	{ tag: TT(t.inserted), color: 'var(--base0B)', backgroundColor: 'color-mix(in oklab, var(--base0B) 12%, transparent)' },
	{ tag: TT(t.deleted), color: 'var(--base08)', backgroundColor: 'color-mix(in oklab, var(--base08) 12%, transparent)' },
	{ tag: TT(t.changed), color: 'var(--base0A)', backgroundColor: 'color-mix(in oklab, var(--base0A) 12%, transparent)' },
])
